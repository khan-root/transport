...
const Button = ({ title, bgWhite=false }) => {
  ...
  return (
    <div>
      <button
        className={`btn relative overflow-hidden px-4 py-3 w-fit before:bg-primary-bluish bg-white border border-primary-bluish font-semibold text-xl tracking-widest
