"use client"
import { missionCoreValueData } from '@/services/__accrodianService';
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 h-full items-center'>
        <div className='space-y-3 p-2 h-full self-center'>
          <div className='flex flex-col gap-3 items-center lg:items-start'>
            ...
            <span className='text-primary-blackGray text-center lg:text-start'>
                ...
                leading bus rental companies in Dubai. 
            </span>
          </div>

          <div className='h-full space-y-4'>
            {missionCoreValueData.map((ele) => (
        ...
        <div className='p-4 h-full'>
            <div className='h-full'>
                <img src='/assets/missionValuesImg.png' alt='faq' className='w-full object-cover' />
            </div>
        </div>
      </div>
    </div>
...
export default MissionCoreValue;
